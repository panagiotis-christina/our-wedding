...
var x = setInterval(function() {
  ...
  document.getElementById("countdown").innerHTML = "<span class='date-block'><span class='num'>" +days + "</span><span class='text'>Μέρες</span></span><span class='date-block'><span class='num'>" + hours + "</span><span class='text'>Ώρες</span></span><span class='date-block'><span class='num'>"
  + minutes + "</span><span class='text'>Λεπτά</span></span><span class='date-block'><span class='num'>" + seconds + "</span><span class='text'>Δευτ.</span></span>";
